...
public final class RILImsCall {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.rttState = _hidl_blob.getInt32(_hidl_offset + 88);
        this.rttChannelId = _hidl_blob.getInt32(_hidl_offset + 92);
        this.cps = _hidl_blob.getInt32(_hidl_offset + 96);
        this.redirectNumber = _hidl_blob.getString(_hidl_offset + 104);
        parcel.readEmbeddedBuffer(this.redirectNumber.getBytes().length + 1, _hidl_blob.handle(), _hidl_offset + 104 + 0, false);
        this.redirectNumberToa = _hidl_blob.getInt32(_hidl_offset + 120);
        this.redirectNumberPresentation = _hidl_blob.getInt32(_hidl_offset + 124);
        this.encryptState = _hidl_blob.getInt32(_hidl_offset + 128);
    }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        _hidl_blob.putInt32(88 + _hidl_offset, this.rttState);
        _hidl_blob.putInt32(92 + _hidl_offset, this.rttChannelId);
        _hidl_blob.putInt32(96 + _hidl_offset, this.cps);
        _hidl_blob.putString(104 + _hidl_offset, this.redirectNumber);
        _hidl_blob.putInt32(120 + _hidl_offset, this.redirectNumberToa);
        _hidl_blob.putInt32(124 + _hidl_offset, this.redirectNumberPresentation);
        _hidl_blob.putInt32(128 + _hidl_offset, this.encryptState);
    }
}
