...
public class KirinMediaCodecEncoder {
    ...
    public void uninit() {
        ...
        VideoCapture2Android videoCapture2Android = this.mVc2a;
        if (videoCapture2Android != null) {
            videoCapture2Android.updateEncSf(null, this.mChannelID);
        }
        HandlerThread handlerThread = this.mEncCallBackThread;
            ...
            public void onOutputBufferAvailable(MediaCodec mediaCodec, int i, MediaCodec.BufferInfo bufferInfo) {
                ...
                try {
                    ...
                    if (bufferInfo.flags == 2) {
                        ...
                        kirinMediaCodecEncoder.nSetSPS(kirinMediaCodecEncoder.lnativeObject, outputBuffer, bufferInfo.size);
                    ...
                    KirinMediaCodecEncoder.this.encoder.releaseOutputBuffer(i, false);
                    KirinMediaCodecEncoder.this.encoderLock.unlock();
                    KirinMediaCodecEncoder kirinMediaCodecEncoder2 = KirinMediaCodecEncoder.this;
                    kirinMediaCodecEncoder2.procEncodedStream(kirinMediaCodecEncoder2.lnativeObject, integer, integer2, KirinMediaCodecEncoder.this.streamBuffer.position(), z);
                    KirinMediaCodecEncoder.this.streamBuffer.rewind();
    ...
    public void markoruseLTRFrame(boolean z, boolean z2, int i) {
        ...
        try {
            if (this.encoder != null && this.started) {
                ...
                Bundle bundle = new Bundle();
                bundle.putInt(VENDOR_KEY_LTRPARAMS, (i2 * 16777216) + (i3 * 65536) + i);
                this.encoder.setParameters(bundle);
            }
        } finally {
            this.encoderLock.unlock();
    ...
    public int setCapSource(VideoCapture2Android videoCapture2Android) {
        ...
        VideoCapture2Android videoCapture2Android2 = this.mVc2a;
        if (videoCapture2Android2 != null) {
            videoCapture2Android2.updateEncSf(null, this.mChannelID);
        }
        ...
        if (widthAfterRendering != this.mWidthIn && widthAfterRendering != this.mHeightIn) {
            ...
            Surface surface = this.mMCSurface;
            if (surface != null) {
                videoCapture2Android.updateEncSf(surface, this.mChannelID);
            } else {
    ...
    public int setResolutionOut(int i, int i2) {
        KirinMediaCodecEncoder kirinMediaCodecEncoder;
        int i3;
        int i4;
        int i5;
        int i6;
        ...
        if (i9 == i && this.mHeightOut == i2) {
            return 0;
        }
        updateEncoderSize(i, i2);
        int i10 = this.mWidthOut;
        int i11 = this.mHeightOut;
        int i12 = this.mHeightIn;
        int i13 = (int) ((i12 / i11) * i10);
        int i14 = this.mWidthIn;
        int i15 = (i14 - i13) / 2;
        if (i12 <= 0 || i14 <= 0) {
            kirinMediaCodecEncoder = this;
            i3 = i11;
            Log.i(TAG, "unenable crop,mHeightIn:" + kirinMediaCodecEncoder.mHeightIn + " mWidthIn:" + kirinMediaCodecEncoder.mWidthIn);
            i4 = 0;
            i5 = 0;
            i6 = 0;
            i7 = 0;
            ...
            i5 = i15 % 2 == 0 ? i15 : i15 + 1;
            i7 = this.mWidthIn - i5;
            if (i7 % 2 == 0) {
                i7--;
            }
            int i16 = this.mHeightIn;
            if (i16 % 2 == 0) {
                i16--;
            }
            Log.i(TAG, "#resolution# ui16CropLeft: " + i5 + " ui16CropRight:" + i7 + " ui16CropTop:0 ui16CropBottom:" + i16 + " cropW:" + i13 + " diff:" + i15 + " iIsEnableScaling:1 iIsEnableCropping:1");
            i4 = 1;
            kirinMediaCodecEncoder = this;
            i3 = i11;
            i8 = i16;
            ...
            int i17 = (int) ((i14 / i10) * i11);
            int i18 = (i12 - i17) / 2;
            i6 = i18 % 2 == 0 ? i18 : i18 + 1;
            kirinMediaCodecEncoder = this;
            i7 = kirinMediaCodecEncoder.mWidthIn;
            if (i7 % 2 == 0) {
                i7--;
            }
            i8 = kirinMediaCodecEncoder.mHeightIn - i6;
            if (i8 % 2 == 0) {
                i8--;
            }
            i3 = i11;
            Log.i(TAG, "#resolution# ui16CropLeft: 0 ui16CropRight:" + i7 + " ui16CropTop:" + i6 + " ui16CropBottom:" + i8 + " cropH:" + i17 + " diff:" + i18 + " iIsEnableScaling:1 iIsEnableCropping:1");
            i4 = 1;
            i5 = 0;
        }
        Bundle bundle = new Bundle();
        bundle.putInt(VENDOR_KEY_CROPLFT, i5);
        bundle.putInt(VENDOR_KEY_CROPRIGHT, i7);
        bundle.putInt(VENDOR_KEY_CROPTOP, i6);
        bundle.putInt(VENDOR_KEY_CROPBOTTOM, i8);
        bundle.putInt(VENDOR_KEY_SCALEWIDTH, i10);
        bundle.putInt(VENDOR_KEY_SCALEHEIGHT, i3);
        bundle.putInt(VENDOR_KEY_ENABLESCALING, 1);
        bundle.putInt(VENDOR_KEY_ENABLECROPPING, i4);
        kirinMediaCodecEncoder.encoderLock.lock();
        try {
            if (kirinMediaCodecEncoder.encoder != null) {
                kirinMediaCodecEncoder.encoder.setParameters(bundle);
            }
            kirinMediaCodecEncoder.encoderLock.unlock();
            return 0;
        } catch (Throwable th) {
            kirinMediaCodecEncoder.encoderLock.unlock();
            throw th;
    ...
    private int createCodec() {
        ...
        int i5 = this.mWidthOut;
        if (i != i5) {
            this.mediaFormat.setInteger(VENDOR_KEY_SCALEWIDTH, i5);
