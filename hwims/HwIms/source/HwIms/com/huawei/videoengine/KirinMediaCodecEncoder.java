...
/* loaded from: KirinMediaCodecEncoder.class */
public class KirinMediaCodecEncoder {
    ...
    /* loaded from: KirinMediaCodecEncoder$EncType.class */
    public enum EncType {
        eH264,
        eH265
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: KirinMediaCodecEncoder$MCType.class */
    public enum MCType {
        eData,
        eSurface
    }
    ...
    public int init(long j, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, boolean z) {
        ...
        try {
            if (this.started) {
                this.encoderLock.unlock();
                return 0;
            } else if (createEncCBThread() != 0) {
                this.encoderLock.unlock();
                return -1;
            } else if (initBuffer() != 0) {
                this.encoderLock.unlock();
                return -1;
            } else if (saveParams(j, i8, i, i2, i3, i4, i5, i6, i7, z) != 0) {
                this.encoderLock.unlock();
                return -1;
            } else if (createCodec() != 0) {
                this.encoderLock.unlock();
                return -1;
            } else {
                if (this.mVc2a != null) {
    ...
    public int setResolutionOut(int i, int i2) {
        ...
        if (this.mWidthOut == 0) {
            ...
            int i8 = this.mWidthOut;
            int i9 = this.mHeightOut;
            int i10 = (int) ((this.mHeightIn / this.mHeightOut) * this.mWidthOut);
            int i11 = (this.mWidthIn - i10) / 2;
            if (this.mHeightIn <= 0 || this.mWidthIn <= 0) {
                ...
                if (i11 >= 0) {
                    i5 = i11 % 2 == 0 ? i11 : i11 + 1;
                    int i12 = this.mWidthIn - i5;
                    i6 = i12;
                    if (i12 % 2 == 0) {
                        i6 = i12 - 1;
                    }
                    i7 = this.mHeightIn % 2 == 0 ? this.mHeightIn - 1 : this.mHeightIn;
                    Log.i(TAG, "#resolution# ui16CropLeft: " + i5 + " ui16CropRight:" + i6 + " ui16CropTop:0 ui16CropBottom:" + i7 + " cropW:" + i10 + " diff:" + i11 + " iIsEnableScaling:1 iIsEnableCropping:1");
                } else if (i11 < 0) {
                    int i13 = (int) ((this.mWidthIn / this.mWidthOut) * this.mHeightOut);
                    int i14 = (this.mHeightIn - i13) / 2;
                    i3 = i14 % 2 == 0 ? i14 : i14 + 1;
                    i6 = this.mWidthIn % 2 == 0 ? this.mWidthIn - 1 : this.mWidthIn;
                    int i15 = this.mHeightIn - i3;
                    i7 = i15;
                    if (i15 % 2 == 0) {
                        i7 = i15 - 1;
                    }
                    Log.i(TAG, "#resolution# ui16CropLeft: 0 ui16CropRight:" + i6 + " ui16CropTop:" + i3 + " ui16CropBottom:" + i7 + " cropH:" + i13 + " diff:" + i14 + " iIsEnableScaling:1 iIsEnableCropping:1");
                    i4 = 1;
                    i5 = 0;
                } else {
                    i5 = 0;
            ...
            bundle.putInt(VENDOR_KEY_SCALEWIDTH, i8);
            bundle.putInt(VENDOR_KEY_SCALEHEIGHT, i9);
    ...
    public void setRoiCoordinate(int i, int[] iArr, long j) {
        if (this.menableROI) {
            this.encoderLock.lock();
            try {
                if (this.encoder == null || !this.started || i == 0) {
                    return;
                }
                Bundle bundle = new Bundle();
                int i2 = i;
