...
/* loaded from: VideoCaptureAndroid.class */
            ...
            try {
                ...
                if (z2) {
                    ...
                    for (Integer num3 : supportedPreviewFormats) {
                        Log.d(TAG, "StartCapture: suport format:" + num3);
                        if (num3.intValue() == i7) {
                            z3 = true;
                        }
                        i8 = num3.intValue();
                ...
                parameters.setPreviewFormat(i9);
                Log.d(TAG, "StartCapture! PIXEL_FORMAT:" + this.PIXEL_FORMAT + " Config PicFormat: " + i5 + "current PicFormat:" + i9 + " pixelFormat.bitsPerPixel:" + this.pixelFormat.bitsPerPixel);
