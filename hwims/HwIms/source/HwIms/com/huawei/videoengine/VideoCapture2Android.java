...
/* loaded from: VideoCapture2Android.class */
public class VideoCapture2Android {
    ...
    /* loaded from: VideoCapture2Android$EAspectRatio.class */
    ...
    /* loaded from: VideoCapture2Android$ObjExtend.class */
    ...
    /* loaded from: VideoCapture2Android$TranObj.class */
    ...
    public VideoCapture2Android() {
        ...
        this.mCaptureCallback = new CameraCaptureSession.CaptureCallback() { // from class: com.huawei.videoengine.VideoCapture2Android.1
            private void process(CaptureResult captureResult) {
                ...
                while (i > 0) {
                    int length2 = faceArr.length - i;
                    int i2 = (faceArr[length2].getBounds().left * VideoCapture2Android.this.mCapW) / VideoCapture2Android.this.mMaxWidth;
                    int i3 = (faceArr[length2].getBounds().top * VideoCapture2Android.this.mCapH) / VideoCapture2Android.this.mMaxHeight;
                    int i4 = (faceArr[length2].getBounds().right * VideoCapture2Android.this.mCapW) / VideoCapture2Android.this.mMaxWidth;
                    int i5 = (faceArr[length2].getBounds().bottom * VideoCapture2Android.this.mCapH) / VideoCapture2Android.this.mMaxHeight;
                    int i6 = length2 * 4;
                    VideoCapture2Android.this.iROI[i6] = i3;
                    VideoCapture2Android.this.iROI[i6 + 1] = VideoCapture2Android.this.mCapW - i4;
                    VideoCapture2Android.this.iROI[i6 + 2] = i5 - i3;
                    VideoCapture2Android.this.iROI[i6 + 3] = i4 - i2;
                    i--;
                }
            }
    ...
    public void getMVPP(float[] fArr, float[] fArr2, float[] fArr3, boolean z, int i, EAspectRatio eAspectRatio, int i2, int i3) {
        ...
        if (eAspectRatio == EAspectRatio.crop) {
            ...
            Matrix.scaleM(fArr3, 0, f10, f5, 1.0f);
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:17:0x0055 A[Catch: all -> 0x0044, TRY_ENTER, TryCatch #0 {, blocks: (B:6:0x0006, B:8:0x000e, B:22:0x0064, B:23:0x009c, B:26:0x009f, B:28:0x00aa, B:39:0x014d, B:41:0x0153, B:43:0x0193, B:29:0x00d0, B:31:0x00df, B:37:0x0123, B:33:0x0106, B:36:0x010e, B:17:0x0055, B:10:0x003d), top: B:50:0x0006, inners: #1, #2 }] */
    /* JADX WARN: Removed duplicated region for block: B:22:0x0064 A[Catch: all -> 0x0044, TRY_ENTER, TryCatch #0 {, blocks: (B:6:0x0006, B:8:0x000e, B:22:0x0064, B:23:0x009c, B:26:0x009f, B:28:0x00aa, B:39:0x014d, B:41:0x0153, B:43:0x0193, B:29:0x00d0, B:31:0x00df, B:37:0x0123, B:33:0x0106, B:36:0x010e, B:17:0x0055, B:10:0x003d), top: B:50:0x0006, inners: #1, #2 }] */
    /* JADX WARN: Removed duplicated region for block: B:26:0x009f A[Catch: all -> 0x0044, TRY_ENTER, TryCatch #0 {, blocks: (B:6:0x0006, B:8:0x000e, B:22:0x0064, B:23:0x009c, B:26:0x009f, B:28:0x00aa, B:39:0x014d, B:41:0x0153, B:43:0x0193, B:29:0x00d0, B:31:0x00df, B:37:0x0123, B:33:0x0106, B:36:0x010e, B:17:0x0055, B:10:0x003d), top: B:50:0x0006, inners: #1, #2 }] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private int updateWinowSurface(com.huawei.videoengine.WindowSurface r6, android.view.Surface r7, java.lang.Object r8, java.lang.String r9) {
        /*
        ...
        synchronized (this.objDestroy) {
            ...
            while (!this.bDestroyed) {
                try {
                    ...
                    e.printStackTrace();
                    int res = this.objDestroy.getRes();
                    i = res;
                    if (res != 0) {
                    ...
                    e2.printStackTrace();
                    int res2 = this.objDestroy.getRes();
                    i = res2;
                    if (res2 != 0) {
                        Log.e(TAG, "destroy failed");
                        i = res2;
            ...
            int res3 = this.objDestroy.getRes();
            i = res3;
            if (res3 != 0) {
                Log.e(TAG, "destroy failed");
                i = res3;
