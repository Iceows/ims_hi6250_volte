...
/* loaded from: IMapconServiceCallback.class */
public interface IMapconServiceCallback extends IInterface {

    /* loaded from: IMapconServiceCallback$Stub.class */
    public static abstract class Stub extends Binder implements IMapconServiceCallback {
        ...
        /* loaded from: IMapconServiceCallback$Stub$Proxy.class */
        ...
        public static IMapconServiceCallback asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            return (queryLocalInterface == null || !(queryLocalInterface instanceof IMapconServiceCallback)) ? new Proxy(iBinder) : (IMapconServiceCallback) queryLocalInterface;
        }
