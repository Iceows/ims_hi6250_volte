...
public class ImsCameraClient {
    ...
    private static final int SOCKET_ERR_CODE_SEGMENT = 1000;
    ...
    public static void setChrVtCallBack(ChrVtCallBack callBack) {
        Log.i("VTPROXY", "setChrVtCallBack in func");
        chrVtCallBack = callBack;
    }

    public static void startChrVtErrReport(int conditionId) {
        Log.i("VTPROXY", "startChrVtErrReport in func");
        ...
        Log.i("VTPROXY", "startChrVtErrReport conditionId : " + conditionId + ", socketErrReason : " + socketErrReason + ", ipAddrErrReason : " + ipAddrErrReason + ", cameraErrReason : " + cameraErrReason);
        intData[0] = conditionId;
        intData[1] = socketErrReason / 1000;
        intData[2] = socketErrReason % 1000;
        intData[3] = ipAddrErrReason;
        intData[4] = cameraErrReason;
        if (chrVtCallBack != null) {
            Log.i("VTPROXY", "startChrVtErrReport run call back func");
    ...
    public static int cameraOpen(int cameraid, int callType) {
        ...
        Log.i("VTPROXY", "initImsThinClient isWriteLog: " + isWriteLog);
        if (isWriteLog) {
    ...
    public static int setNearEndSurface(SurfaceView localView) {
        if (localView == null) {
            Log.i("VTPROXY", "setNearEndSurface localView is null ");
            return 1;
        }
        if (localView.getHolder() == null) {
            Log.i("VTPROXY", "setNearEndSurface the surfaceHolder of localView is null ");
            return 1;
        }
    ...
    public static int setCameraParameter(int paramKey, Object paramValue) {
        if (paramValue == null) {
            Log.i("VTPROXY", "setCameraParameter paramValue is null. ");
            return 1;
        }
        if (paramKey != 0 && paramKey != 1) {
            Log.i("VTPROXY", "setCameraParameter invalid key. ");
            return 1;
        }
        ...
        return setParameter(paramKey, strValue);
    }
}
