...
public class Texture2dProgram {
    ...
    public Texture2dProgram(ProgramType programType) {
        ...
        int i = AnonymousClass1.$SwitchMap$com$huawei$videoengine$Texture2dProgram$ProgramType[programType.ordinal()];
        if (i == 1) {
    ...
    /* renamed from: com.huawei.videoengine.Texture2dProgram$1, reason: invalid class name */
    /* loaded from: C:\Users\MOUNIERR\AppData\Local\Temp\jadx-542703519837145295.dex */
    static /* synthetic */ class AnonymousClass1 {
        static final /* synthetic */ int[] $SwitchMap$com$huawei$videoengine$Texture2dProgram$ProgramType = new int[ProgramType.values().length];

        static {
            try {
                $SwitchMap$com$huawei$videoengine$Texture2dProgram$ProgramType[ProgramType.TEXTURE_2D.ordinal()] = 1;
            } catch (NoSuchFieldError e) {
            }
            try {
                $SwitchMap$com$huawei$videoengine$Texture2dProgram$ProgramType[ProgramType.TEXTURE_EXT.ordinal()] = 2;
            } catch (NoSuchFieldError e2) {
            }
            try {
                $SwitchMap$com$huawei$videoengine$Texture2dProgram$ProgramType[ProgramType.TEXTURE_EXT_BW.ordinal()] = 3;
            } catch (NoSuchFieldError e3) {
            }
            try {
                $SwitchMap$com$huawei$videoengine$Texture2dProgram$ProgramType[ProgramType.TEXTURE_EXT_FILT.ordinal()] = 4;
    ...
    public void deleteTextureObject(int i) {
        ...
        GlUtil.checkGlError("glDeleteTextures " + i);
    }
