...
public class VideoCaptureAndroid implements Camera.PreviewCallback, SurfaceHolder.Callback {
    ...
    public VideoCaptureAndroid(int i, long j, Camera camera, VideoCaptureDeviceInfoAndroid.AndroidVideoCaptureDevice androidVideoCaptureDevice) {
        ...
        Log.d(TAG, "VideoCaptureAndroid.java! enter VideoCaptureAndroid! java version:LOG-iMedia Video VILTE 1.2.1.SPC005.B018");
    ...
    public int startCapture(int i, int i2, int i3, int i4) {
        ...
        int i6 = i4;
        if (DEBUG) {
            Log.d(TAG, "StartCapture width:" + i + " height:" + i2 + " fps:" + i3 + " previewImageType:" + i6);
        }
            ...
            try {
                ...
                if (98 != i6) {
                    ...
                    if (!model.equals("M310")) {
                        Log.e(TAG, "StartCapture input rawType is: " + i6 + "  modle: " + model + " is not supported");
                        captureSysLock.unlock();
                        return -1;
                    }
                ...
                Log.d(TAG, "StartCapture! PIXEL_FORMAT:" + this.PIXEL_FORMAT + " Config PicFormat: " + i6 + "current PicFormat:" + i5 + " pixelFormat.bitsPerPixel:" + this.pixelFormat.bitsPerPixel);
                ...
                int i8 = ((i * i2) * this.pixelFormat.bitsPerPixel) / 8;
    ...
    public void surfaceCreated(SurfaceHolder surfaceHolder) {
        ...
        try {
            ...
            } else if (this.isStartPreviewFlag) {
