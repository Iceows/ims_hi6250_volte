...
public class VideoCapture2Android {
    ...
    private static final String java_version = "LOG-iMedia Video VILTE 1.2.1.SPC005.B018";
    ...
    public VideoCapture2Android() {
        ...
        this.mCaptureCallback = new CameraCaptureSession.CaptureCallback() { // from class: com.huawei.videoengine.VideoCapture2Android.1
            private void process(CaptureResult captureResult) {
                if (!VideoCapture2Android.this.mEnableROI) {
                    return;
                }
    ...
    public VideoCapture2Android(long j) {
        ...
        this.mRotEnc = 0;
        init();
        Log.i(TAG, "VideoCapture2Android.java! enter VideoCapture2Android! java version:LOG-iMedia Video VILTE 1.2.1.SPC005.B018");
    ...
    /* JADX WARN: Removed duplicated region for block: B:12:0x0062 A[Catch: all -> 0x002c, TryCatch #2 {all -> 0x002c, blocks: (B:39:0x0005, B:41:0x000b, B:8:0x003d, B:9:0x0060, B:12:0x0062, B:14:0x006a, B:15:0x00cd, B:17:0x00d1, B:18:0x00fa, B:20:0x0080, B:24:0x0088, B:22:0x00b2, B:30:0x009f, B:28:0x00a4, B:35:0x0034, B:42:0x0028), top: B:38:0x0005, inners: #3 }] */
    /* JADX WARN: Removed duplicated region for block: B:35:0x0034 A[Catch: all -> 0x002c, TryCatch #2 {all -> 0x002c, blocks: (B:39:0x0005, B:41:0x000b, B:8:0x003d, B:9:0x0060, B:12:0x0062, B:14:0x006a, B:15:0x00cd, B:17:0x00d1, B:18:0x00fa, B:20:0x0080, B:24:0x0088, B:22:0x00b2, B:30:0x009f, B:28:0x00a4, B:35:0x0034, B:42:0x0028), top: B:38:0x0005, inners: #3 }] */
    /* JADX WARN: Removed duplicated region for block: B:6:0x0032  */
    /* JADX WARN: Removed duplicated region for block: B:8:0x003d A[Catch: all -> 0x002c, TryCatch #2 {all -> 0x002c, blocks: (B:39:0x0005, B:41:0x000b, B:8:0x003d, B:9:0x0060, B:12:0x0062, B:14:0x006a, B:15:0x00cd, B:17:0x00d1, B:18:0x00fa, B:20:0x0080, B:24:0x0088, B:22:0x00b2, B:30:0x009f, B:28:0x00a4, B:35:0x0034, B:42:0x0028), top: B:38:0x0005, inners: #3 }] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    private int updateWinowSurface(WindowSurface windowSurface, Surface surface, Object obj, String str) {
        boolean z;
        synchronized (obj) {
            if (windowSurface != null) {
                try {
                    if (windowSurface.getSurface() == surface) {
                        Log.i(TAG, "upWindowSF:" + str + ", is same as current's");
                        z = false;
                        if (surface != null) {
                            z = false;
                        ...
                        if (z) {
                            Log.i(TAG, "no need to create windowSF(" + str + "), beause Surface:" + surface + " is null, or Surface isValid");
                            return 0;
                        }
                        if (str.equals("mWindowSurface")) {
                            this.mWindowSurface = new WindowSurface(this.mEglCore, surface, false);
                            Log.i(TAG, "#winsf# mWindowSurface create");
                            this.mWindowSurface.makeCurrent();
                        } else if (str.equals("mEncWindowSurface")) {
                            try {
                                ...
                                Log.e(TAG, "RuntimeException error");
                                nMsgSend(3, this.mNativeClassInstance);
                            } catch (Exception e2) {
                                e2.printStackTrace();
                            }
                        } else {
                            Log.e(TAG, "updateWinowSurface str:" + str + "not mWindowSurface or mEncWindowSurface");
                        }
                        if (this.mFullFrameBlit == null) {
                            Log.i(TAG, "#step#FullFrame 2d programe create ");
                ...
                synchronized (VideoCapture2Android.this.mWinLock) {
                    ...
                    synchronized (VideoCapture2Android.this.mEncWinLock) {
                        if (VideoCapture2Android.this.mEncWindowSurface != null) {
                            VideoCapture2Android videoCapture2Android = VideoCapture2Android.this;
                            if (!videoCapture2Android.nDropEncFrame(videoCapture2Android.mNativeClassInstance, 0, 0, VideoCapture2Android.this.mRotLeft, VideoCapture2Android.this.mCapH, VideoCapture2Android.this.mCapW)) {
                                synchronized (VideoCapture2Android.this.mMCELock) {
                                    if (VideoCapture2Android.this.mEnableROI && VideoCapture2Android.this.mMCE != null) {
    ...
    public void updateEncSf(Surface surface, int i) {
        ...
        SurfaceEncoder surfaceEncoder = this.mSfE;
        if (surfaceEncoder != null && surface != null) {
            surfaceEncoder.setEncSurface(surface, i);
        }
        if (this.mBackgroundHandler == null) {
    ...
    public int destroy() {
        ...
        Log.i(TAG, "#step#stopBackgroundThread start");
        ...
        Log.i(TAG, "#step#stopBackgroundThread end");
        CameraCaptureSession cameraCaptureSession = this.mCaptureSession;
        if (cameraCaptureSession != null) {
    ...
    public void getMVPP(float[] fArr, float[] fArr2, float[] fArr3, boolean z, int i, EAspectRatio eAspectRatio, int i2, int i3) {
        ...
        if (eAspectRatio == EAspectRatio.crop) {
            if (i == 90 || i == 270) {
                ...
                Matrix.scaleM(fArr3, 0, f9, f6, 1.0f);
            } else if ((f3 / f4) - (this.mCapW / this.mCapH) < 0.0f) {
                float f10 = f / 2.0f;
                if (z) {
                    f6 = (-f4) / 2.0f;
                }
                Matrix.scaleM(fArr3, 0, f10, f6, 1.0f);
            } else {
            ...
            if (i3 < i2) {
                ...
                Matrix.scaleM(fArr3, 0, f11, f5, 1.0f);
            }
        } else {
            if (z) {
                f5 = (-f3) / 2.0f;
