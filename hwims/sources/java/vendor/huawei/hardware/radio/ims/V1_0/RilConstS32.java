...
public final class RilConstS32 {
    ...
    public static final String dumpBitfield(int o) {
        ...
        if ((o & RIL_REQUEST_HW_DEVICE_RESERVED_27) == 526) {
            list.add("RIL_REQUEST_HW_DEVICE_RESERVED_27");
            flipped |= RIL_REQUEST_HW_DEVICE_RESERVED_27;
        }
        if ((o & 527) == 527) {
        ...
        if ((o & RIL_REQUEST_HW_VOICE_LOOPBACK) == 530) {
            list.add("RIL_REQUEST_HW_VOICE_LOOPBACK");
            flipped |= RIL_REQUEST_HW_VOICE_LOOPBACK;
        }
        if ((o & 531) == 531) {
        ...
        if ((o & RIL_REQUEST_HW_SET_WIFI_POWER_GRADE) == 534) {
            list.add("RIL_REQUEST_HW_SET_WIFI_POWER_GRADE");
            flipped |= RIL_REQUEST_HW_SET_WIFI_POWER_GRADE;
        }
        if ((o & RIL_REQUEST_SIM_OPEN_CHANNEL_WITH_P2) == 535) {
            list.add("RIL_REQUEST_SIM_OPEN_CHANNEL_WITH_P2");
            flipped |= RIL_REQUEST_SIM_OPEN_CHANNEL_WITH_P2;
        }
        if ((o & RIL_REQUEST_HW_IMPACT_ANT_DEVSTATE) == 536) {
            list.add("RIL_REQUEST_HW_IMPACT_ANT_DEVSTATE");
            flipped |= RIL_REQUEST_HW_IMPACT_ANT_DEVSTATE;
        }
        if ((o & RIL_REQUEST_HW_SET_EMERGENCY_NUMBERS) == 537) {
            list.add("RIL_REQUEST_HW_SET_EMERGENCY_NUMBERS");
            flipped |= RIL_REQUEST_HW_SET_EMERGENCY_NUMBERS;
        }
        if ((o & RIL_REQUEST_HW_MODEM_POWER) == 538) {
            list.add("RIL_REQUEST_HW_MODEM_POWER");
            flipped |= RIL_REQUEST_HW_MODEM_POWER;
        }
        if ((o & RIL_REQUEST_HW_SET_SIM_LESS) == 539) {
            list.add("RIL_REQUEST_HW_SET_SIM_LESS");
            flipped |= RIL_REQUEST_HW_SET_SIM_LESS;
        }
        if ((o & RIL_REQUEST_HW_SET_TRANSMIT_POWER) == 540) {
            list.add("RIL_REQUEST_HW_SET_TRANSMIT_POWER");
            flipped |= RIL_REQUEST_HW_SET_TRANSMIT_POWER;
        }
        if ((o & RIL_REQUEST_HW_RESTRAT_RILD) == 541) {
            list.add("RIL_REQUEST_HW_RESTRAT_RILD");
            flipped |= RIL_REQUEST_HW_RESTRAT_RILD;
        }
        if ((o & RIL_REQUEST_HW_SIM_TRANSMIT_BASIC) == 542) {
            list.add("RIL_REQUEST_HW_SIM_TRANSMIT_BASIC");
            flipped |= RIL_REQUEST_HW_SIM_TRANSMIT_BASIC;
        }
        if ((o & RIL_REQUEST_HW_SIM_OPEN_CHANNEL) == 543) {
            list.add("RIL_REQUEST_HW_SIM_OPEN_CHANNEL");
            flipped |= RIL_REQUEST_HW_SIM_OPEN_CHANNEL;
        }
        if ((o & RIL_REQUEST_HW_SIM_CLOSE_CHANNEL) == 544) {
            list.add("RIL_REQUEST_HW_SIM_CLOSE_CHANNEL");
            flipped |= RIL_REQUEST_HW_SIM_CLOSE_CHANNEL;
        }
        if ((o & RIL_REQUEST_HW_SIM_TRANSMIT_CHANNEL) == 545) {
            list.add("RIL_REQUEST_HW_SIM_TRANSMIT_CHANNEL");
            flipped |= RIL_REQUEST_HW_SIM_TRANSMIT_CHANNEL;
        }
        if ((o & RIL_REQUEST_HW_MODIFY_DATA_PROFILE) == 546) {
            list.add("RIL_REQUEST_HW_MODIFY_DATA_PROFILE");
            flipped |= RIL_REQUEST_HW_MODIFY_DATA_PROFILE;
        }
        if ((o & RIL_REQUEST_HW_DATA_CONNECTION_DETACH) == 547) {
            list.add("RIL_REQUEST_HW_DATA_CONNECTION_DETACH");
            flipped |= RIL_REQUEST_HW_DATA_CONNECTION_DETACH;
        }
        if ((o & RIL_REQUEST_HW_DATA_CONNECTION_ATTACH) == 548) {
            list.add("RIL_REQUEST_HW_DATA_CONNECTION_ATTACH");
            flipped |= RIL_REQUEST_HW_DATA_CONNECTION_ATTACH;
        }
        if ((o & RIL_REQUEST_HW_GET_DATA_PROFILE) == 549) {
            list.add("RIL_REQUEST_HW_GET_DATA_PROFILE");
            flipped |= RIL_REQUEST_HW_GET_DATA_PROFILE;
        }
        if ((o & RIL_REQUEST_HW_GET_SIM_CAPACITY) == 550) {
            list.add("RIL_REQUEST_HW_GET_SIM_CAPACITY");
            flipped |= RIL_REQUEST_HW_GET_SIM_CAPACITY;
        }
        if ((o & RIL_REQUEST_HW_SET_LONG_MESSAGE) == 551) {
            list.add("RIL_REQUEST_HW_SET_LONG_MESSAGE");
            flipped |= RIL_REQUEST_HW_SET_LONG_MESSAGE;
        }
        if ((o & RIL_REQUEST_HW_CGSMS_MESSAGE) == 552) {
            list.add("RIL_REQUEST_HW_CGSMS_MESSAGE");
            flipped |= RIL_REQUEST_HW_CGSMS_MESSAGE;
        }
        if ((o & RIL_REQUEST_HW_RESET_ALL_CONNECTIONS) == 553) {
            list.add("RIL_REQUEST_HW_RESET_ALL_CONNECTIONS");
            flipped |= RIL_REQUEST_HW_RESET_ALL_CONNECTIONS;
        }
        if ((o & RIL_REQUEST_HW_RRC_CONTROL) == 554) {
            list.add("RIL_REQUEST_HW_RRC_CONTROL");
            flipped |= RIL_REQUEST_HW_RRC_CONTROL;
        }
        if ((o & RIL_REQUEST_HW_SET_VOICECALL_BACKGROUND_STATE) == 555) {
            list.add("RIL_REQUEST_HW_SET_VOICECALL_BACKGROUND_STATE");
            flipped |= RIL_REQUEST_HW_SET_VOICECALL_BACKGROUND_STATE;
        }
        if ((o & RIL_REQUEST_HW_GET_VOICECALL_BACKGROUND_STATE) == 556) {
            list.add("RIL_REQUEST_HW_GET_VOICECALL_BACKGROUND_STATE");
            flipped |= RIL_REQUEST_HW_GET_VOICECALL_BACKGROUND_STATE;
        }
        if ((o & RIL_REQUEST_HW_GET_IMEI_VERIFY_STATUS) == 557) {
            list.add("RIL_REQUEST_HW_GET_IMEI_VERIFY_STATUS");
            flipped |= RIL_REQUEST_HW_GET_IMEI_VERIFY_STATUS;
        }
        if ((o & RIL_REQUEST_HW_SET_NETWORK_RAT_AND_SRVDOMAIN_CFG) == 558) {
            list.add("RIL_REQUEST_HW_SET_NETWORK_RAT_AND_SRVDOMAIN_CFG");
            flipped |= RIL_REQUEST_HW_SET_NETWORK_RAT_AND_SRVDOMAIN_CFG;
        }
        if ((o & RIL_REQUEST_HW_SET_PSDOMAIN_AUTOATTACH_TYPE) == 559) {
            list.add("RIL_REQUEST_HW_SET_PSDOMAIN_AUTOATTACH_TYPE");
            flipped |= RIL_REQUEST_HW_SET_PSDOMAIN_AUTOATTACH_TYPE;
        }
        if ((o & RIL_REQUEST_HW_GET_PSDOMAIN_AUTOATTACH_TYPE) == 560) {
            list.add("RIL_REQUEST_HW_GET_PSDOMAIN_AUTOATTACH_TYPE");
            flipped |= RIL_REQUEST_HW_GET_PSDOMAIN_AUTOATTACH_TYPE;
        }
        if ((o & RIL_REQUEST_HW_SET_NCELL_MONITOR_STATE) == 561) {
            list.add("RIL_REQUEST_HW_SET_NCELL_MONITOR_STATE");
            flipped |= RIL_REQUEST_HW_SET_NCELL_MONITOR_STATE;
        }
        if ((o & RIL_REQUEST_HW_GET_USER_SERVICE_STATE) == 562) {
            list.add("RIL_REQUEST_HW_GET_USER_SERVICE_STATE");
            flipped |= RIL_REQUEST_HW_GET_USER_SERVICE_STATE;
        }
        if ((o & RIL_REQUEST_HW_MONITOR_SIM_IN_SLOT_IND) == 563) {
            list.add("RIL_REQUEST_HW_MONITOR_SIM_IN_SLOT_IND");
            flipped |= RIL_REQUEST_HW_MONITOR_SIM_IN_SLOT_IND;
        }
        if ((o & RIL_REQUEST_HW_SET_SIM_SLOT_CFG) == 564) {
            list.add("RIL_REQUEST_HW_SET_SIM_SLOT_CFG");
            flipped |= RIL_REQUEST_HW_SET_SIM_SLOT_CFG;
        }
        if ((o & RIL_REQUEST_HW_GET_SIM_SLOT_CFG) == 565) {
            list.add("RIL_REQUEST_HW_GET_SIM_SLOT_CFG");
            flipped |= RIL_REQUEST_HW_GET_SIM_SLOT_CFG;
        }
        if ((o & RIL_REQUEST_HW_HANDLE_DETECT) == 566) {
            list.add("RIL_REQUEST_HW_HANDLE_DETECT");
            flipped |= RIL_REQUEST_HW_HANDLE_DETECT;
        }
        if ((o & RIL_REQUEST_HW_GET_HANDLE_DETECT) == 567) {
            list.add("RIL_REQUEST_HW_GET_HANDLE_DETECT");
            flipped |= RIL_REQUEST_HW_GET_HANDLE_DETECT;
        }
        if ((o & RIL_REQUEST_HW_SIM_GET_ATR) == 568) {
            list.add("RIL_REQUEST_HW_SIM_GET_ATR");
            flipped |= RIL_REQUEST_HW_SIM_GET_ATR;
        }
        if ((o & RIL_REQUEST_HW_VSIM_GET_ALGROITHM_AND_MODEM_PUBKEY) == 569) {
            list.add("RIL_REQUEST_HW_VSIM_GET_ALGROITHM_AND_MODEM_PUBKEY");
            flipped |= RIL_REQUEST_HW_VSIM_GET_ALGROITHM_AND_MODEM_PUBKEY;
        }
        if ((o & RIL_REQUEST_HW_VSIM_SET_SERVER_PUBKEY) == 570) {
            list.add("RIL_REQUEST_HW_VSIM_SET_SERVER_PUBKEY");
            flipped |= RIL_REQUEST_HW_VSIM_SET_SERVER_PUBKEY;
        }
        if ((o & RIL_REQUEST_HW_FILE_WRITE) == 571) {
            list.add("RIL_REQUEST_HW_FILE_WRITE");
            flipped |= RIL_REQUEST_HW_FILE_WRITE;
        }
        if ((o & RIL_REQUEST_HW_VSIM_GET_SIM_CONTENT) == 572) {
            list.add("RIL_REQUEST_HW_VSIM_GET_SIM_CONTENT");
            flipped |= RIL_REQUEST_HW_VSIM_GET_SIM_CONTENT;
        }
        if ((o & RIL_REQUEST_HW_VSIM_SET_SIM_STATE) == 573) {
            list.add("RIL_REQUEST_HW_VSIM_SET_SIM_STATE");
            flipped |= RIL_REQUEST_HW_VSIM_SET_SIM_STATE;
        }
        if ((o & RIL_REQUEST_HW_VSIM_GET_SIM_STATE) == 574) {
            list.add("RIL_REQUEST_HW_VSIM_GET_SIM_STATE");
            flipped |= RIL_REQUEST_HW_VSIM_GET_SIM_STATE;
        }
        if ((o & RIL_REQUEST_HW_GET_EOPLMN_LIST) == 575) {
            list.add("RIL_REQUEST_HW_GET_EOPLMN_LIST");
            flipped |= RIL_REQUEST_HW_GET_EOPLMN_LIST;
        }
        if ((o & RIL_REQUEST_HW_SET_EOPLMN_LIST) == 576) {
            list.add("RIL_REQUEST_HW_SET_EOPLMN_LIST");
            flipped |= RIL_REQUEST_HW_SET_EOPLMN_LIST;
        }
        if ((o & RIL_REQUEST_HW_GET_SYSTEM_INFO_EX) == 577) {
            list.add("RIL_REQUEST_HW_GET_SYSTEM_INFO_EX");
            flipped |= RIL_REQUEST_HW_GET_SYSTEM_INFO_EX;
        }
        if ((o & RIL_REQUEST_HW_GET_PLMN_INFO) == 578) {
            list.add("RIL_REQUEST_HW_GET_PLMN_INFO");
            flipped |= RIL_REQUEST_HW_GET_PLMN_INFO;
        }
        if ((o & RIL_REQUEST_HW_IMS_DIAL) == 579) {
            list.add("RIL_REQUEST_HW_IMS_DIAL");
            flipped |= RIL_REQUEST_HW_IMS_DIAL;
        }
        if ((o & RIL_REQUEST_HW_IMS_GET_CURRENT_CALLS) == 580) {
            list.add("RIL_REQUEST_HW_IMS_GET_CURRENT_CALLS");
            flipped |= RIL_REQUEST_HW_IMS_GET_CURRENT_CALLS;
        }
        if ((o & RIL_REQUEST_HW_IMS_HANGUP) == 581) {
            list.add("RIL_REQUEST_HW_IMS_HANGUP");
            flipped |= RIL_REQUEST_HW_IMS_HANGUP;
        }
        if ((o & RIL_REQUEST_HW_IMS_HANGUP_WAITING_OR_BACKGROUND) == 582) {
            list.add("RIL_REQUEST_HW_IMS_HANGUP_WAITING_OR_BACKGROUND");
            flipped |= RIL_REQUEST_HW_IMS_HANGUP_WAITING_OR_BACKGROUND;
        }
        if ((o & RIL_REQUEST_HW_IMS_HANGUP_FOREGROUND_RESUME_BACKGROUND) == 583) {
            list.add("RIL_REQUEST_HW_IMS_HANGUP_FOREGROUND_RESUME_BACKGROUND");
            flipped |= RIL_REQUEST_HW_IMS_HANGUP_FOREGROUND_RESUME_BACKGROUND;
        }
        if ((o & RIL_REQUEST_HW_IMS_SWITCH_WAITING_OR_HOLDING_AND_ACTIVE) == 584) {
            list.add("RIL_REQUEST_HW_IMS_SWITCH_WAITING_OR_HOLDING_AND_ACTIVE");
            flipped |= RIL_REQUEST_HW_IMS_SWITCH_WAITING_OR_HOLDING_AND_ACTIVE;
        }
        if ((o & RIL_REQUEST_HW_IMS_CONFERENCE) == 585) {
            list.add("RIL_REQUEST_HW_IMS_CONFERENCE");
            flipped |= RIL_REQUEST_HW_IMS_CONFERENCE;
        }
        if ((o & RIL_REQUEST_HW_IMS_UDUB) == 586) {
            list.add("RIL_REQUEST_HW_IMS_UDUB");
            flipped |= RIL_REQUEST_HW_IMS_UDUB;
        }
        if ((o & RIL_REQUEST_HW_IMS_LAST_CALL_FAIL_CAUSE) == 587) {
            list.add("RIL_REQUEST_HW_IMS_LAST_CALL_FAIL_CAUSE");
            flipped |= RIL_REQUEST_HW_IMS_LAST_CALL_FAIL_CAUSE;
        }
        if ((o & RIL_REQUEST_HW_IMS_SEND_USSD) == 588) {
            list.add("RIL_REQUEST_HW_IMS_SEND_USSD");
            flipped |= RIL_REQUEST_HW_IMS_SEND_USSD;
        }
        if ((o & RIL_REQUEST_HW_IMS_CANCEL_USSD) == 589) {
            list.add("RIL_REQUEST_HW_IMS_CANCEL_USSD");
            flipped |= RIL_REQUEST_HW_IMS_CANCEL_USSD;
        }
        if ((o & RIL_REQUEST_HW_IMS_ANSWER) == 590) {
            list.add("RIL_REQUEST_HW_IMS_ANSWER");
            flipped |= RIL_REQUEST_HW_IMS_ANSWER;
        }
        if ((o & RIL_REQUEST_HW_IMS_DTMF) == 591) {
            list.add("RIL_REQUEST_HW_IMS_DTMF");
            flipped |= RIL_REQUEST_HW_IMS_DTMF;
        }
        if ((o & RIL_REQUEST_HW_IMS_DTMF_START) == 592) {
            list.add("RIL_REQUEST_HW_IMS_DTMF_START");
            flipped |= RIL_REQUEST_HW_IMS_DTMF_START;
        }
        if ((o & RIL_REQUEST_HW_IMS_DTMF_STOP) == 593) {
            list.add("RIL_REQUEST_HW_IMS_DTMF_STOP");
            flipped |= RIL_REQUEST_HW_IMS_DTMF_STOP;
        }
        if ((o & RIL_REQUEST_HW_IMS_EXPLICIT_CALL_TRANSFER) == 594) {
            list.add("RIL_REQUEST_HW_IMS_EXPLICIT_CALL_TRANSFER");
            flipped |= RIL_REQUEST_HW_IMS_EXPLICIT_CALL_TRANSFER;
        }
        if ((o & RIL_REQUEST_HW_IMS_REG_STATE_CHANGE) == 595) {
            list.add("RIL_REQUEST_HW_IMS_REG_STATE_CHANGE");
            flipped |= RIL_REQUEST_HW_IMS_REG_STATE_CHANGE;
        }
        if ((o & RIL_REQUEST_HW_IMS_IMSVOPS_IND) == 596) {
            list.add("RIL_REQUEST_HW_IMS_IMSVOPS_IND");
            flipped |= RIL_REQUEST_HW_IMS_IMSVOPS_IND;
        }
        if ((o & RIL_REQUEST_HW_IMS_SET_MUTE) == 597) {
            list.add("RIL_REQUEST_HW_IMS_SET_MUTE");
            flipped |= RIL_REQUEST_HW_IMS_SET_MUTE;
        }
        if ((o & RIL_REQUEST_HW_ANT_SWITCH) == 598) {
            list.add("RIL_REQUEST_HW_ANT_SWITCH");
            flipped |= RIL_REQUEST_HW_ANT_SWITCH;
        }
        if ((o & RIL_REQUEST_HW_GET_ANT_SWITCH) == 599) {
            list.add("RIL_REQUEST_HW_GET_ANT_SWITCH");
            flipped |= RIL_REQUEST_HW_GET_ANT_SWITCH;
        }
        if ((o & RIL_REQUEST_GET_POL_CAPABILITY) == 600) {
            list.add("RIL_REQUEST_GET_POL_CAPABILITY");
            flipped |= RIL_REQUEST_GET_POL_CAPABILITY;
        }
        if ((o & RIL_REQUEST_GET_POL_LIST) == 601) {
            list.add("RIL_REQUEST_GET_POL_LIST");
            flipped |= RIL_REQUEST_GET_POL_LIST;
        }
        if ((o & RIL_REQUEST_SET_POL_ENTRY) == 602) {
            list.add("RIL_REQUEST_SET_POL_ENTRY");
            flipped |= RIL_REQUEST_SET_POL_ENTRY;
        }
        if ((o & RIL_REQUEST_HW_GET_ISMCOEX) == 603) {
            list.add("RIL_REQUEST_HW_GET_ISMCOEX");
            flipped |= RIL_REQUEST_HW_GET_ISMCOEX;
        }
        if ((o & RIL_REQUEST_HW_SET_ISMCOEX) == 604) {
            list.add("RIL_REQUEST_HW_SET_ISMCOEX");
            flipped |= RIL_REQUEST_HW_SET_ISMCOEX;
        }
        if ((o & RIL_REQUEST_HW_IMS_IMPU) == 605) {
            list.add("RIL_REQUEST_HW_IMS_IMPU");
            flipped |= RIL_REQUEST_HW_IMS_IMPU;
        }
        if ((o & RIL_REQUEST_HW_SET_BAND_CFG) == 606) {
            list.add("RIL_REQUEST_HW_SET_BAND_CFG");
            flipped |= RIL_REQUEST_HW_SET_BAND_CFG;
        }
        if ((o & RIL_REQUEST_HW_GET_BAND_CFG) == 607) {
            list.add("RIL_REQUEST_HW_GET_BAND_CFG");
            flipped |= RIL_REQUEST_HW_GET_BAND_CFG;
        }
        if ((o & RIL_REQUEST_HW_SET_RAT_COMBINE_PRIO) == 608) {
            list.add("RIL_REQUEST_HW_SET_RAT_COMBINE_PRIO");
            flipped |= RIL_REQUEST_HW_SET_RAT_COMBINE_PRIO;
        }
        if ((o & RIL_REQUEST_HW_GET_RAT_COMBINE_PRIO) == 609) {
            list.add("RIL_REQUEST_HW_GET_RAT_COMBINE_PRIO");
            flipped |= RIL_REQUEST_HW_GET_RAT_COMBINE_PRIO;
        }
        if ((o & RIL_REQUEST_HW_GET_SIMLOCK_STATUS) == 610) {
            list.add("RIL_REQUEST_HW_GET_SIMLOCK_STATUS");
            flipped |= RIL_REQUEST_HW_GET_SIMLOCK_STATUS;
        }
        if ((o & RIL_REQUEST_HW_GET_ICCID) == 611) {
            list.add("RIL_REQUEST_HW_GET_ICCID");
            flipped |= RIL_REQUEST_HW_GET_ICCID;
        }
        if ((o & RIL_REQUEST_HW_IMS_ADD_CONFERENCE_MEMBER) == 612) {
            list.add("RIL_REQUEST_HW_IMS_ADD_CONFERENCE_MEMBER");
            flipped |= RIL_REQUEST_HW_IMS_ADD_CONFERENCE_MEMBER;
        }
        if ((o & RIL_REQUEST_HW_IMS_GET_CLIR) == 613) {
            list.add("RIL_REQUEST_HW_IMS_GET_CLIR");
            flipped |= RIL_REQUEST_HW_IMS_GET_CLIR;
        }
        if ((o & RIL_REQUEST_HW_IMS_SET_CLIR) == 614) {
            list.add("RIL_REQUEST_HW_IMS_SET_CLIR");
            flipped |= RIL_REQUEST_HW_IMS_SET_CLIR;
        }
        if ((o & RIL_REQUEST_HW_IMS_SET_CALL_WAITING) == 615) {
            list.add("RIL_REQUEST_HW_IMS_SET_CALL_WAITING");
            flipped |= RIL_REQUEST_HW_IMS_SET_CALL_WAITING;
        }
        if ((o & RIL_REQUEST_HW_QUERY_GSM_NMR_INFO) == 616) {
            list.add("RIL_REQUEST_HW_QUERY_GSM_NMR_INFO");
            flipped |= RIL_REQUEST_HW_QUERY_GSM_NMR_INFO;
        }
        if ((o & RIL_REQUEST_HW_UICC_AUTH) == 617) {
            list.add("RIL_REQUEST_HW_UICC_AUTH");
            flipped |= RIL_REQUEST_HW_UICC_AUTH;
        }
        if ((o & RIL_REQUEST_HW_UICC_GBA_BOOTSTRAP) == 618) {
            list.add("RIL_REQUEST_HW_UICC_GBA_BOOTSTRAP");
            flipped |= RIL_REQUEST_HW_UICC_GBA_BOOTSTRAP;
        }
        if ((o & RIL_REQUEST_HW_UPDATE_UICC_FILE) == 619) {
            list.add("RIL_REQUEST_HW_UPDATE_UICC_FILE");
            flipped |= RIL_REQUEST_HW_UPDATE_UICC_FILE;
        }
        if ((o & RIL_REQUEST_HW_GET_UICC_FILE) == 620) {
            list.add("RIL_REQUEST_HW_GET_UICC_FILE");
            flipped |= RIL_REQUEST_HW_GET_UICC_FILE;
        }
        if ((o & RIL_REQUEST_HW_UICC_KS_NAF_AUTH) == 621) {
            list.add("RIL_REQUEST_HW_UICC_KS_NAF_AUTH");
            flipped |= RIL_REQUEST_HW_UICC_KS_NAF_AUTH;
        }
        if ((o & RIL_REQUEST_HW_INITIAL_MESSAGE) == 622) {
            list.add("RIL_REQUEST_HW_INITIAL_MESSAGE");
            flipped |= RIL_REQUEST_HW_INITIAL_MESSAGE;
        }
        if ((o & RIL_REQUEST_HW_GET_LTE_FREQ_WITH_WLAN_COEX) == 623) {
            list.add("RIL_REQUEST_HW_GET_LTE_FREQ_WITH_WLAN_COEX");
            flipped |= RIL_REQUEST_HW_GET_LTE_FREQ_WITH_WLAN_COEX;
        }
        if ((o & RIL_REQUEST_HW_SET_ACTIVE_MODEM_MODE) == 624) {
            list.add("RIL_REQUEST_HW_SET_ACTIVE_MODEM_MODE");
            flipped |= RIL_REQUEST_HW_SET_ACTIVE_MODEM_MODE;
        }
        if ((o & RIL_REQUEST_HW_GET_DS_FLOW_INFO) == 625) {
            list.add("RIL_REQUEST_HW_GET_DS_FLOW_INFO");
            flipped |= RIL_REQUEST_HW_GET_DS_FLOW_INFO;
        }
        if ((o & RIL_REQUEST_HW_CLEAR_DS_FLOW_INFO) == 626) {
            list.add("RIL_REQUEST_HW_CLEAR_DS_FLOW_INFO");
            flipped |= RIL_REQUEST_HW_CLEAR_DS_FLOW_INFO;
        }
        if ((o & RIL_REQUEST_HW_SET_DS_FLOW_REPORT_FLAG) == 627) {
            list.add("RIL_REQUEST_HW_SET_DS_FLOW_REPORT_FLAG");
            flipped |= RIL_REQUEST_HW_SET_DS_FLOW_REPORT_FLAG;
        }
        if ((o & RIL_REQUEST_HW_GET_DEVICE_VERSION) == 628) {
            list.add("RIL_REQUEST_HW_GET_DEVICE_VERSION");
            flipped |= RIL_REQUEST_HW_GET_DEVICE_VERSION;
        }
        if ((o & RIL_REQUEST_HW_SET_TEE_DATA_READY_FLAG) == 629) {
            list.add("RIL_REQUEST_HW_SET_TEE_DATA_READY_FLAG");
            flipped |= RIL_REQUEST_HW_SET_TEE_DATA_READY_FLAG;
        }
        if ((o & RIL_REQUEST_HW_SWITCH_SIM_SLOT_WITHOUT_RESTART_RILD) == 630) {
            list.add("RIL_REQUEST_HW_SWITCH_SIM_SLOT_WITHOUT_RESTART_RILD");
            flipped |= RIL_REQUEST_HW_SWITCH_SIM_SLOT_WITHOUT_RESTART_RILD;
        }
        if ((o & RIL_REQUEST_HW_GET_SCI_CHG_CFG) == 631) {
            list.add("RIL_REQUEST_HW_GET_SCI_CHG_CFG");
            flipped |= RIL_REQUEST_HW_GET_SCI_CHG_CFG;
        }
        if ((o & RIL_REQUEST_HW_DSDS_GET_SIM_STATUS) == 632) {
            list.add("RIL_REQUEST_HW_DSDS_GET_SIM_STATUS");
            flipped |= RIL_REQUEST_HW_DSDS_GET_SIM_STATUS;
        }
        if ((o & RIL_REQUEST_HW_IMS_MODIFY_CALL_INITIATE) == 633) {
            list.add("RIL_REQUEST_HW_IMS_MODIFY_CALL_INITIATE");
            flipped |= RIL_REQUEST_HW_IMS_MODIFY_CALL_INITIATE;
        }
        if ((o & RIL_REQUEST_HW_IMS_MODIFY_CALL_CONFIRM) == 634) {
            list.add("RIL_REQUEST_HW_IMS_MODIFY_CALL_CONFIRM");
            flipped |= RIL_REQUEST_HW_IMS_MODIFY_CALL_CONFIRM;
        }
        if ((o & RIL_REQUEST_HW_SET_VOICEPREFER_STATUS) == 635) {
            list.add("RIL_REQUEST_HW_SET_VOICEPREFER_STATUS");
            flipped |= RIL_REQUEST_HW_SET_VOICEPREFER_STATUS;
        }
        if ((o & RIL_REQUEST_HW_GET_VOICEPREFER_STATUS) == 636) {
            list.add("RIL_REQUEST_HW_GET_VOICEPREFER_STATUS");
            flipped |= RIL_REQUEST_HW_GET_VOICEPREFER_STATUS;
        }
        if ((o & RIL_REQUEST_HW_IMS_ECONF_DIAL) == 637) {
            list.add("RIL_REQUEST_HW_IMS_ECONF_DIAL");
            flipped |= RIL_REQUEST_HW_IMS_ECONF_DIAL;
        }
        if ((o & RIL_REQUEST_HW_IMS_GET_ECONF_INFO) == 638) {
            list.add("RIL_REQUEST_HW_IMS_GET_ECONF_INFO");
            flipped |= RIL_REQUEST_HW_IMS_GET_ECONF_INFO;
        }
        if ((o & RIL_REQUEST_HW_IMS_ECONF_REMOVE_MEMBER) == 639) {
            list.add("RIL_REQUEST_HW_IMS_ECONF_REMOVE_MEMBER");
            flipped |= RIL_REQUEST_HW_IMS_ECONF_REMOVE_MEMBER;
        }
        if ((o & RIL_REQUEST_HW_IMS_MERGE_ECONF) == 640) {
            list.add("RIL_REQUEST_HW_IMS_MERGE_ECONF");
            flipped |= RIL_REQUEST_HW_IMS_MERGE_ECONF;
        }
        if ((o & RIL_REQUEST_HW_IMS_ECONF_ADD_MEMBER) == 641) {
            list.add("RIL_REQUEST_HW_IMS_ECONF_ADD_MEMBER");
            flipped |= RIL_REQUEST_HW_IMS_ECONF_ADD_MEMBER;
        }
        if ((o & RIL_REQUEST_HW_IMS_GET_ECONF_LAST_FAIL_CAUSE) == 642) {
            list.add("RIL_REQUEST_HW_IMS_GET_ECONF_LAST_FAIL_CAUSE");
            flipped |= RIL_REQUEST_HW_IMS_GET_ECONF_LAST_FAIL_CAUSE;
        }
        if ((o & RIL_REQUEST_HW_RAT_RFIC_CHANNEL_SWITCH) == 643) {
            list.add("RIL_REQUEST_HW_RAT_RFIC_CHANNEL_SWITCH");
            flipped |= RIL_REQUEST_HW_RAT_RFIC_CHANNEL_SWITCH;
        }
        if ((o & RIL_REQUEST_HW_SET_LTE_RELEASE_VERSION) == 644) {
            list.add("RIL_REQUEST_HW_SET_LTE_RELEASE_VERSION");
            flipped |= RIL_REQUEST_HW_SET_LTE_RELEASE_VERSION;
        }
        if ((o & RIL_REQUEST_HW_GET_LTE_RELEASE_VERSION) == 645) {
            list.add("RIL_REQUEST_HW_GET_LTE_RELEASE_VERSION");
            flipped |= RIL_REQUEST_HW_GET_LTE_RELEASE_VERSION;
        }
        if ((o & RIL_REQUEST_HW_AP_SET_DS_FLOW_CONFIG) == 646) {
            list.add("RIL_REQUEST_HW_AP_SET_DS_FLOW_CONFIG");
            flipped |= RIL_REQUEST_HW_AP_SET_DS_FLOW_CONFIG;
        }
        if ((o & RIL_REQUEST_HW_VSIM_CHECK_CARD) == 647) {
            list.add("RIL_REQUEST_HW_VSIM_CHECK_CARD");
            flipped |= RIL_REQUEST_HW_VSIM_CHECK_CARD;
        }
        if ((o & RIL_REQUEST_SET_DS_FLOW_NV_WRITE_CFG_PARA) == 648) {
            list.add("RIL_REQUEST_SET_DS_FLOW_NV_WRITE_CFG_PARA");
            flipped |= RIL_REQUEST_SET_DS_FLOW_NV_WRITE_CFG_PARA;
        }
        if ((o & RIL_REQUEST_GET_DS_FLOW_NV_WRITE_CFG_PARA) == 649) {
            list.add("RIL_REQUEST_GET_DS_FLOW_NV_WRITE_CFG_PARA");
            flipped |= RIL_REQUEST_GET_DS_FLOW_NV_WRITE_CFG_PARA;
        }
        if ((o & RIL_REQUEST_HW_SET_IMS_SWITCH) == 650) {
            list.add("RIL_REQUEST_HW_SET_IMS_SWITCH");
            flipped |= RIL_REQUEST_HW_SET_IMS_SWITCH;
        }
        if ((o & RIL_REQUEST_HW_GET_IMS_SWITCH) == 651) {
            list.add("RIL_REQUEST_HW_GET_IMS_SWITCH");
            flipped |= RIL_REQUEST_HW_GET_IMS_SWITCH;
        }
        if ((o & RIL_REQUEST_HW_ICC_PREF_APP_SWITCH) == 652) {
            list.add("RIL_REQUEST_HW_ICC_PREF_APP_SWITCH");
            flipped |= RIL_REQUEST_HW_ICC_PREF_APP_SWITCH;
        }
        if ((o & RIL_REQUEST_HW_GET_CIMSI) == 653) {
            list.add("RIL_REQUEST_HW_GET_CIMSI");
            flipped |= RIL_REQUEST_HW_GET_CIMSI;
        }
        if ((o & RIL_REQUEST_HW_SET_CDMA_MODE_SIDE) == 654) {
            list.add("RIL_REQUEST_HW_SET_CDMA_MODE_SIDE");
            flipped |= RIL_REQUEST_HW_SET_CDMA_MODE_SIDE;
        }
        if ((o & RIL_REQUEST_HW_SET_UE_OPERATION_MODE) == 655) {
            list.add("RIL_REQUEST_HW_SET_UE_OPERATION_MODE");
            flipped |= RIL_REQUEST_HW_SET_UE_OPERATION_MODE;
        }
        if ((o & RIL_REQUEST_HW_VSIM_POWER) == 656) {
            list.add("RIL_REQUEST_HW_VSIM_POWER");
            flipped |= RIL_REQUEST_HW_VSIM_POWER;
        }
        if ((o & RIL_REQUEST_HW_NOTIFY_CMODEM_STATUS) == 657) {
            list.add("RIL_REQUEST_HW_NOTIFY_CMODEM_STATUS");
            flipped |= RIL_REQUEST_HW_NOTIFY_CMODEM_STATUS;
        }
        if ((o & RIL_REQUEST_HW_GET_CTROAMINFO) == 658) {
            list.add("RIL_REQUEST_HW_GET_CTROAMINFO");
            flipped |= RIL_REQUEST_HW_GET_CTROAMINFO;
        }
        if ((o & RIL_REQUEST_HW_SET_CT_OOS_COUNT) == 659) {
            list.add("RIL_REQUEST_HW_SET_CT_OOS_COUNT");
            flipped |= RIL_REQUEST_HW_SET_CT_OOS_COUNT;
        }
        if ((o & RIL_REQUEST_HW_IMS_DOMAIN_CONFIG) == 660) {
            list.add("RIL_REQUEST_HW_IMS_DOMAIN_CONFIG");
            flipped |= RIL_REQUEST_HW_IMS_DOMAIN_CONFIG;
        }
        if ((o & RIL_REQUEST_HW_VOWIFI_IMSA_MSG) == 661) {
            list.add("RIL_REQUEST_HW_VOWIFI_IMSA_MSG");
            flipped |= RIL_REQUEST_HW_VOWIFI_IMSA_MSG;
        }
        if ((o & RIL_REQUEST_HW_GET_IMS_DOMAIN) == 662) {
            list.add("RIL_REQUEST_HW_GET_IMS_DOMAIN");
            flipped |= RIL_REQUEST_HW_GET_IMS_DOMAIN;
        }
        if ((o & RIL_REQUEST_HW_GET_CDMA_MODE_SIDE) == 663) {
            list.add("RIL_REQUEST_HW_GET_CDMA_MODE_SIDE");
            flipped |= RIL_REQUEST_HW_GET_CDMA_MODE_SIDE;
        }
        if ((o & RIL_REQUEST_HW_VOWIFI_UICC_AUTH) == 664) {
            list.add("RIL_REQUEST_HW_VOWIFI_UICC_AUTH");
            flipped |= RIL_REQUEST_HW_VOWIFI_UICC_AUTH;
        }
        if ((o & RIL_REQUEST_HW_QUERY_SERVICE_CELL_BAND) == 665) {
            list.add("RIL_REQUEST_HW_QUERY_SERVICE_CELL_BAND");
            flipped |= RIL_REQUEST_HW_QUERY_SERVICE_CELL_BAND;
        }
        if ((o & RIL_REQUEST_HW_SET_TIME) == 666) {
            list.add("RIL_REQUEST_HW_SET_TIME");
            flipped |= RIL_REQUEST_HW_SET_TIME;
        }
        if ((o & RIL_REQUEST_VSIM_BASEBAND_VERSION) == 667) {
            list.add("RIL_REQUEST_VSIM_BASEBAND_VERSION");
            flipped |= RIL_REQUEST_VSIM_BASEBAND_VERSION;
        }
        if ((o & RIL_REQUEST_HW_SET_VT_LTE_QUALITY_RPT_CFG) == 668) {
            list.add("RIL_REQUEST_HW_SET_VT_LTE_QUALITY_RPT_CFG");
            flipped |= RIL_REQUEST_HW_SET_VT_LTE_QUALITY_RPT_CFG;
        }
        if ((o & RIL_REQUEST_HW_IMS_REJ_CALL) == 669) {
            list.add("RIL_REQUEST_HW_IMS_REJ_CALL");
            flipped |= RIL_REQUEST_HW_IMS_REJ_CALL;
        }
        if ((o & RIL_REQUEST_HW_REJ_CALL) == 670) {
            list.add("RIL_REQUEST_HW_REJ_CALL");
            flipped |= RIL_REQUEST_HW_REJ_CALL;
        }
        if ((o & RIL_REQUEST_HW_IMS_CHANNEL_INFO) == 671) {
            list.add("RIL_REQUEST_HW_IMS_CHANNEL_INFO");
            flipped |= RIL_REQUEST_HW_IMS_CHANNEL_INFO;
        }
        if ((o & RIL_REQUEST_HW_CHANNEL_INFO) == 672) {
            list.add("RIL_REQUEST_HW_CHANNEL_INFO");
            flipped |= RIL_REQUEST_HW_CHANNEL_INFO;
        }
        if ((o & RIL_REQUEST_HW_GET_RAT_COMBINE_MODE) == 673) {
            list.add("RIL_REQUEST_HW_GET_RAT_COMBINE_MODE");
            flipped |= RIL_REQUEST_HW_GET_RAT_COMBINE_MODE;
        }
        if ((o & RIL_REQUEST_HW_IMS_SET_DM_PCSCF) == 674) {
            list.add("RIL_REQUEST_HW_IMS_SET_DM_PCSCF");
            flipped |= RIL_REQUEST_HW_IMS_SET_DM_PCSCF;
        }
        if ((o & RIL_REQUEST_HW_IMS_SET_DM_DYN) == 675) {
            list.add("RIL_REQUEST_HW_IMS_SET_DM_DYN");
            flipped |= RIL_REQUEST_HW_IMS_SET_DM_DYN;
        }
        if ((o & RIL_REQUEST_HW_IMS_SET_DM_TIMER) == 676) {
            list.add("RIL_REQUEST_HW_IMS_SET_DM_TIMER");
            flipped |= RIL_REQUEST_HW_IMS_SET_DM_TIMER;
        }
        if ((o & RIL_REQUEST_HW_IMS_SET_DM_SMS) == 677) {
            list.add("RIL_REQUEST_HW_IMS_SET_DM_SMS");
            flipped |= RIL_REQUEST_HW_IMS_SET_DM_SMS;
        }
        if ((o & RIL_REQUEST_HW_IMS_GET_DM_PCSCF) == 678) {
            list.add("RIL_REQUEST_HW_IMS_GET_DM_PCSCF");
            flipped |= RIL_REQUEST_HW_IMS_GET_DM_PCSCF;
        }
        if ((o & RIL_REQUEST_HW_IMS_GET_DM_TIMER) == 679) {
            list.add("RIL_REQUEST_HW_IMS_GET_DM_TIMER");
            flipped |= RIL_REQUEST_HW_IMS_GET_DM_TIMER;
        }
        if ((o & RIL_REQUEST_HW_IMS_GET_DM_DYN) == 680) {
            list.add("RIL_REQUEST_HW_IMS_GET_DM_DYN");
            flipped |= RIL_REQUEST_HW_IMS_GET_DM_DYN;
        }
        if ((o & RIL_REQUEST_HW_IMS_GET_DM_SMS) == 681) {
            list.add("RIL_REQUEST_HW_IMS_GET_DM_SMS");
            flipped |= RIL_REQUEST_HW_IMS_GET_DM_SMS;
        }
        if ((o & RIL_REQUEST_HW_IMS_GET_DM_USER) == 682) {
            list.add("RIL_REQUEST_HW_IMS_GET_DM_USER");
            flipped |= RIL_REQUEST_HW_IMS_GET_DM_USER;
        }
        if ((o & RIL_REQUEST_HW_IMS_SET_NICK_NAME) == 683) {
            list.add("RIL_REQUEST_HW_IMS_SET_NICK_NAME");
            flipped |= RIL_REQUEST_HW_IMS_SET_NICK_NAME;
        }
        if ((o & RIL_REQUEST_HW_IMS_GET_NICK_NAME) == 684) {
            list.add("RIL_REQUEST_HW_IMS_GET_NICK_NAME");
            flipped |= RIL_REQUEST_HW_IMS_GET_NICK_NAME;
        }
        if ((o & RIL_REQUEST_HW_IMS_BATTERY_STATUS) == 685) {
            list.add("RIL_REQUEST_HW_IMS_BATTERY_STATUS");
            flipped |= RIL_REQUEST_HW_IMS_BATTERY_STATUS;
        }
        if ((o & RIL_REQUEST_HW_IMS_REGISTER) == 686) {
            list.add("RIL_REQUEST_HW_IMS_REGISTER");
            flipped |= RIL_REQUEST_HW_IMS_REGISTER;
        }
        if ((o & RIL_REQUEST_HW_SET_BASIC_COMM_PARA_READY) == 687) {
            list.add("RIL_REQUEST_HW_SET_BASIC_COMM_PARA_READY");
            flipped |= RIL_REQUEST_HW_SET_BASIC_COMM_PARA_READY;
        }
        if ((o & RIL_REQUEST_HW_SET_PSEUDO_INFO) == 688) {
            list.add("RIL_REQUEST_HW_SET_PSEUDO_INFO");
            flipped |= RIL_REQUEST_HW_SET_PSEUDO_INFO;
        }
        if ((o & RIL_REQUEST_HW_SET_CELLULAR_CLOUD_PARA_READY) == 689) {
            list.add("RIL_REQUEST_HW_SET_CELLULAR_CLOUD_PARA_READY");
            flipped |= RIL_REQUEST_HW_SET_CELLULAR_CLOUD_PARA_READY;
        }
        if ((o & RIL_REQUEST_HW_SIGNAL_STRENGTH) == 690) {
            list.add("RIL_REQUEST_HW_SIGNAL_STRENGTH");
            flipped |= RIL_REQUEST_HW_SIGNAL_STRENGTH;
        }
        if ((o & RIL_REQUEST_HW_QUERY_AVAILABLE_CSGID) == 691) {
            list.add("RIL_REQUEST_HW_QUERY_AVAILABLE_CSGID");
            flipped |= RIL_REQUEST_HW_QUERY_AVAILABLE_CSGID;
        }
        if ((o & RIL_REQUEST_HW_SELECT_CSGID) == 692) {
            list.add("RIL_REQUEST_HW_SELECT_CSGID");
            flipped |= RIL_REQUEST_HW_SELECT_CSGID;
        }
        if ((o & RIL_REQUEST_HW_IMS_LAST_CALL_CAUSE) == 693) {
            list.add("RIL_REQUEST_HW_IMS_LAST_CALL_CAUSE");
            flipped |= RIL_REQUEST_HW_IMS_LAST_CALL_CAUSE;
        }
        if ((o & RIL_REQUEST_HW_SET_IMSVT_CAPABILITY) == 694) {
            list.add("RIL_REQUEST_HW_SET_IMSVT_CAPABILITY");
            flipped |= RIL_REQUEST_HW_SET_IMSVT_CAPABILITY;
        }
        if ((o & RIL_REQUEST_HW_SET_WIFI_EMERGENCY_AID) == 695) {
            list.add("RIL_REQUEST_HW_SET_WIFI_EMERGENCY_AID");
            flipped |= RIL_REQUEST_HW_SET_WIFI_EMERGENCY_AID;
        }
        if ((o & RIL_REQUEST_HW_SEND_LAA_CMD) == 696) {
            list.add("RIL_REQUEST_HW_SEND_LAA_CMD");
            flipped |= RIL_REQUEST_HW_SEND_LAA_CMD;
        }
        if ((o & RIL_REQUEST_HW_SETUP_DATA_CALL_EMERGENCY) == 697) {
            list.add("RIL_REQUEST_HW_SETUP_DATA_CALL_EMERGENCY");
            flipped |= RIL_REQUEST_HW_SETUP_DATA_CALL_EMERGENCY;
        }
        if ((o & RIL_REQUEST_HW_DEACTIVATE_DATA_CALL_EMERGENCY) == 698) {
            list.add("RIL_REQUEST_HW_DEACTIVATE_DATA_CALL_EMERGENCY");
            flipped |= RIL_REQUEST_HW_DEACTIVATE_DATA_CALL_EMERGENCY;
        }
        if ((o & RIL_REQUEST_HW_GET_CELL_INFO_LIST_OTDOA) == 699) {
            list.add("RIL_REQUEST_HW_GET_CELL_INFO_LIST_OTDOA");
            flipped |= RIL_REQUEST_HW_GET_CELL_INFO_LIST_OTDOA;
        }
        if ((o & RIL_REQUEST_HW_IMS_SWITCH_WAITING_OR_HOLDING_AND_ACTIVE_WITH_TYPE) == 700) {
        ...
        if ((o & RIL_REQUEST_HW_VOLTE_IMPI) == 708) {
            list.add("RIL_REQUEST_HW_VOLTE_IMPI");
            flipped |= RIL_REQUEST_HW_VOLTE_IMPI;
        }
        if ((o & RIL_REQUEST_HW_VOLTE_DOMAIN) == 709) {
            list.add("RIL_REQUEST_HW_VOLTE_DOMAIN");
            flipped |= RIL_REQUEST_HW_VOLTE_DOMAIN;
        }
        if ((o & RIL_REQUEST_CANCEL_IMS_VIDEO_CALL) == 710) {
            list.add("RIL_REQUEST_CANCEL_IMS_VIDEO_CALL");
            flipped |= RIL_REQUEST_CANCEL_IMS_VIDEO_CALL;
        }
        if ((o & RIL_REQUEST_HW_SET_DATA_SWITCH) == 711) {
            list.add("RIL_REQUEST_HW_SET_DATA_SWITCH");
            flipped |= RIL_REQUEST_HW_SET_DATA_SWITCH;
        }
        if ((o & RIL_REQUEST_HW_SET_DATA_ROAM_SWITCH) == 712) {
            list.add("RIL_REQUEST_HW_SET_DATA_ROAM_SWITCH");
            flipped |= RIL_REQUEST_HW_SET_DATA_ROAM_SWITCH;
        }
        if ((o & RIL_REQUEST_HW_SET_IMS_SMS_CONFIG) == 713) {
            list.add("RIL_REQUEST_HW_SET_IMS_SMS_CONFIG");
            flipped |= RIL_REQUEST_HW_SET_IMS_SMS_CONFIG;
        }
        if ((o & RIL_REQUEST_HW_GET_IMS_SMS_CONFIG) == 714) {
            list.add("RIL_REQUEST_HW_GET_IMS_SMS_CONFIG");
            flipped |= RIL_REQUEST_HW_GET_IMS_SMS_CONFIG;
        }
        if ((o & RIL_REQUEST_HW_GET_CSGIDSRCH_INFO) == 715) {
            list.add("RIL_REQUEST_HW_GET_CSGIDSRCH_INFO");
            flipped |= RIL_REQUEST_HW_GET_CSGIDSRCH_INFO;
        }
        if ((o & RIL_REQUEST_HW_SET_REATTACH_REQUIRED_UNSOL) == 716) {
            list.add("RIL_REQUEST_HW_SET_REATTACH_REQUIRED_UNSOL");
            flipped |= RIL_REQUEST_HW_SET_REATTACH_REQUIRED_UNSOL;
        }
        if ((o & RIL_REQUEST_HW_SET_DEEP_NO_DISTURB_SWITCH) == 717) {
            list.add("RIL_REQUEST_HW_SET_DEEP_NO_DISTURB_SWITCH");
            flipped |= RIL_REQUEST_HW_SET_DEEP_NO_DISTURB_SWITCH;
        }
        if ((o & RIL_REQUEST_HW_ACTIVE_NCFG_BIN) == 718) {
            list.add("RIL_REQUEST_HW_ACTIVE_NCFG_BIN");
            flipped |= RIL_REQUEST_HW_ACTIVE_NCFG_BIN;
        }
        if ((o & RIL_REQUEST_HW_IMS_GET_CURRENT_CALLS_V1_2) == 719) {
            list.add("RIL_REQUEST_HW_IMS_GET_CURRENT_CALLS_V1_2");
            flipped |= RIL_REQUEST_HW_IMS_GET_CURRENT_CALLS_V1_2;
        }
        if ((o & RIL_REQUEST_HW_GET_CURRENT_CALLS_V1_2) == 720) {
            list.add("RIL_REQUEST_HW_GET_CURRENT_CALLS_V1_2");
            flipped |= RIL_REQUEST_HW_GET_CURRENT_CALLS_V1_2;
        }
        if ((o & RIL_REQUEST_HW_GET_NUM_OF_REC_PSE_BASE_STATION) == 721) {
            list.add("RIL_REQUEST_HW_GET_NUM_OF_REC_PSE_BASE_STATION");
            flipped |= RIL_REQUEST_HW_GET_NUM_OF_REC_PSE_BASE_STATION;
        }
        if ((o & RIL_REQUEST_HW_IMS_SET_RTT_STATUS) == 722) {
            list.add("RIL_REQUEST_HW_IMS_SET_RTT_STATUS");
            flipped |= RIL_REQUEST_HW_IMS_SET_RTT_STATUS;
        }
        if ((o & RIL_REQUEST_HW_IMS_ANSWER_V1_3) == 723) {
            list.add("RIL_REQUEST_HW_IMS_ANSWER_V1_3");
            flipped |= RIL_REQUEST_HW_IMS_ANSWER_V1_3;
        }
        if ((o & RIL_REQUEST_HW_IMS_DIAL_V1_3) == 724) {
            list.add("RIL_REQUEST_HW_IMS_DIAL_V1_3");
            flipped |= RIL_REQUEST_HW_IMS_DIAL_V1_3;
        }
        if ((o & RIL_REQUEST_HW_IMS_SWITCH_WAITING_OR_HOLDING_AND_ACTIVE_WITH_TYPE_V1_3) == 725) {
            list.add("RIL_REQUEST_HW_IMS_SWITCH_WAITING_OR_HOLDING_AND_ACTIVE_WITH_TYPE_V1_3");
            flipped |= RIL_REQUEST_HW_IMS_SWITCH_WAITING_OR_HOLDING_AND_ACTIVE_WITH_TYPE_V1_3;
        }
        if ((o & RIL_REQUEST_HW_IMS_RTT_MODIFY) == 726) {
            list.add("RIL_REQUEST_HW_IMS_RTT_MODIFY");
            flipped |= RIL_REQUEST_HW_IMS_RTT_MODIFY;
        }
        if ((o & RIL_REQUEST_HW_IMS_GET_CURRENT_CALLS_V1_3) == 727) {
            list.add("RIL_REQUEST_HW_IMS_GET_CURRENT_CALLS_V1_3");
            flipped |= RIL_REQUEST_HW_IMS_GET_CURRENT_CALLS_V1_3;
        }
        if ((o & RIL_REQUEST_HW_SEND_NCFG_OPER_INFO) == 728) {
            list.add("RIL_REQUEST_HW_SEND_NCFG_OPER_INFO");
            flipped |= RIL_REQUEST_HW_SEND_NCFG_OPER_INFO;
        }
        if ((o & RIL_REQUEST_HW_IMS_RESTRAT_RILD) == 729) {
            list.add("RIL_REQUEST_HW_IMS_RESTRAT_RILD");
            flipped |= RIL_REQUEST_HW_IMS_RESTRAT_RILD;
        }
        if ((o & RIL_REQUEST_HW_IMS_UICC_AUTH) == 730) {
            list.add("RIL_REQUEST_HW_IMS_UICC_AUTH");
            flipped |= RIL_REQUEST_HW_IMS_UICC_AUTH;
        }
        if ((o & 2000) == 2000) {
        ...
        if ((o & RIL_UNSOL_HW_IMS_RINGBACK_TONE) == 2033) {
            list.add("RIL_UNSOL_HW_IMS_RINGBACK_TONE");
            flipped |= RIL_UNSOL_HW_IMS_RINGBACK_TONE;
        }
        if ((o & RIL_UNSOL_HW_IMS_RESPONSE_HANDOVER) == 2034) {
            list.add("RIL_UNSOL_HW_IMS_RESPONSE_HANDOVER");
            flipped |= RIL_UNSOL_HW_IMS_RESPONSE_HANDOVER;
        }
        if ((o & RIL_UNSOL_HW_IMS_SRV_STATUS_UPDATE) == 2035) {
            list.add("RIL_UNSOL_HW_IMS_SRV_STATUS_UPDATE");
            flipped |= RIL_UNSOL_HW_IMS_SRV_STATUS_UPDATE;
        }
        if ((o & RIL_UNSOL_HW_IMS_ON_USSD) == 2036) {
            list.add("RIL_UNSOL_HW_IMS_ON_USSD");
            flipped |= RIL_UNSOL_HW_IMS_ON_USSD;
        }
        if ((o & 2037) == 2037) {
        ...
        if ((o & RIL_UNSOL_HW_IMS_DATA_CONNECT_IND) == 2062) {
            list.add("RIL_UNSOL_HW_IMS_DATA_CONNECT_IND");
            flipped |= RIL_UNSOL_HW_IMS_DATA_CONNECT_IND;
        }
        if ((o & RIL_UNSOL_HW_IMS_DATA_DISCONNECT_IND) == 2063) {
            list.add("RIL_UNSOL_HW_IMS_DATA_DISCONNECT_IND");
            flipped |= RIL_UNSOL_HW_IMS_DATA_DISCONNECT_IND;
        }
        if ((o & 2064) == 2064) {
        ...
        if ((o & RIL_UNSOL_HW_INIT_LOCINFO) == 2070) {
            list.add("RIL_UNSOL_HW_INIT_LOCINFO");
            flipped |= RIL_UNSOL_HW_INIT_LOCINFO;
        }
        if ((o & RIL_UNSOL_HW_LIMIT_PDP_ACT_IND) == 2071) {
            list.add("RIL_UNSOL_HW_LIMIT_PDP_ACT_IND");
            flipped |= RIL_UNSOL_HW_LIMIT_PDP_ACT_IND;
        }
        if ((o & 2072) == 2072) {
        ...
        if ((o & RIL_UNSOL_HW_SIGNAL_STRENGTH) == 2077) {
            list.add("RIL_UNSOL_HW_SIGNAL_STRENGTH");
            flipped |= RIL_UNSOL_HW_SIGNAL_STRENGTH;
        }
        if ((o & 2078) == 2078) {
        ...
        if ((o & RIL_UNSOL_HW_DSDS_MODE_STATE_IND) == 2086) {
            list.add("RIL_UNSOL_HW_DSDS_MODE_STATE_IND");
            flipped |= RIL_UNSOL_HW_DSDS_MODE_STATE_IND;
        }
        if ((o & RIL_UNSOL_HW_LOW_TEMPRATURE) == 2087) {
            list.add("RIL_UNSOL_HW_LOW_TEMPRATURE");
            flipped |= RIL_UNSOL_HW_LOW_TEMPRATURE;
        }
        if ((o & 2088) == 2088) {
